# -*- coding: utf-8 -*-
# Implement the Spanish Reina Valera 1865
...
class RV1865(VerseText):
    " Implements the VerseText abstract model for the Reina Valera (RV1865) text. "
    
    translation = 'RV1865'
    
    # Chapter is 'Capítulo', Psalm is 'Salmo' en Español.
    bible = Bible('Reina Valera 1865', 'RV1865', book_data=base_bible_data, language=u'Español',
                  chapter_text='Capítulo %d', psalm_text='Salmo %d')
    
    
    class Meta:
        db_table = 'bibletext_rv1865'
        app_label = 'bibletext'
        verbose_name = 'Reina Valera 1865'

VerseText.register_version(RV1865) # Make sure the RV1865 is available for usage.